...
Bấm đúp `install.bat` — script tự động:
...
- Hoặc lệnh: `python gui_web.py`

→ Mở cửa sổ Web UI → **nhập ảnh + tài khoản ngay trong giao diện** → bấm **▶ Vẽ tất cả** hoặc **👥 Vẽ đa tài khoản**.
